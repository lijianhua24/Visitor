...
public class ListProAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context context;
    List<String> data1;
    private boolean check;
    public ListProAdapter(RegisterActivity registerActivity, List<String> data1) {
